...
class ControlMySpa {
  ...
  async getProfile () {
    ...
    const req = await axios.get(
      'https://iot.controlmyspa.com/user-management/profile', {
      headers: {
        Accept: '*/*',
    ...
    if (req.status === 200) {
      const body = req.data.data.user._id;
      this.userInfo = body;
  ...
  async getDefaultSpa () {
    ...
    const req = await axios.get(
      'https://iot.controlmyspa.com/spas?page=0&pageSize=20',
      {
        headers: {
          Accept: '*/*',
          Authorization: 'Bearer ' + this.tokenData.accessToken
  ...
  async getSpa () {
    ...
    const req = await axios.get(
      `https://iot.controlmyspa.com/spas/${this.currentSpaId}/current-state`,
      {
        headers: {
          Accept: 'application/json, text/plain, */*',
          Authorization: 'Bearer ' + this.tokenData.accessToken
