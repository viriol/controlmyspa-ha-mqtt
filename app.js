...
class App extends EventEmitter {
  ...
  climateDiscovery(spa) {
    ...
    let config = {
      ...
      "temperature_state_template": "{% if value_json.desiredTemp is defined %}{{ value_json.desiredTemp }}{% elif value_json.targetDesiredTemp is defined %}{{ value_json.targetDesiredTemp }}{% else %}None{% endif %}",
      "temperature_command_template": "{{value}}",
      "current_temperature_topic": stateTopic,
      "current_temperature_template": "{% if value_json.currentTemp is defined %}{{value_json.currentTemp}}{% else %}None{% endif %}",
      "precision": precision,
      "temp_step": tempStep,
